...
class Mevius(Node):
    def __init__(self):
        ...
        self.joint_names = self.get_parameter('JOINT_NAME').get_parameter_value().string_array_value
        self.stiffness = {
            'collar': self.get_parameter('control.stiffness.collar')
            .get_parameter_value()
            .double_value,
            'hip': self.get_parameter('control.stiffness.hip').get_parameter_value().double_value,
            'knee': self.get_parameter('control.stiffness.knee').get_parameter_value().double_value,
        }
        self.damping = {
            'collar': self.get_parameter('control.damping.collar')
            .get_parameter_value()
            .double_value,
            'hip': self.get_parameter('control.damping.hip').get_parameter_value().double_value,
            'knee': self.get_parameter('control.damping.knee').get_parameter_value().double_value,
        }
